...
export const AppHeader = () => {
  return (
    <div className="absolute w-full bottom-0 left-0 tablet:bottom-[50px] tablet:left-[35px] desktop:left-[88px] desktop:bottom-[92px] desktop:flex desktop:items-center desktop:gap-4">
      <div className="hidden font-light text-neutral-white desktop:flex gap-4">
        <span>menu</span>
        <span className="w-[1px] bg-neutral-white" />
      </div>

      <header className="bg-neutral-white/10 tablet:rounded-lg tablet:w-[40%] desktop:w-[162px]">
        <ul className="flex justify-around py-4 text-neutral-white font-light text-sm">
          ...
          <CustomLink href={"/projects"} className={linkStyles}>
            <Pin />
            <span className={labelStyles}>Side Projects</span>
          </CustomLink>
        </ul>
      </header>
    </div>
