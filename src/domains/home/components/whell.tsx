...
export const Wheel = ({
	...
	return (
		<div
			...
			className="relative grid place-items-center w-[120px] cursor-pointer "
			onClick={goToExperienceScreen}
		>
			<svg
				data-ui="wheel"
				viewBox="0 0 138 136"
			...
			<span className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-10 font-display text-background font-light  text-center tracking-wide ">
				push to start
			</span>
		</div>
	);
