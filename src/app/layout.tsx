...
const mainContainerClasses = clsx(
  "overflow-auto absolute overflow-x-hidden overflow-y-auto w-full top-[76px] h-[calc(100dvh-76px-116px)] md:top-[92px] md:h-[calc(100dvh-92px-116px)] lg:top-[124px] lg:h-[calc(100dvh-124px-116px)]"
);
