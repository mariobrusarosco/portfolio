...
const NameAndFirstName = () => {
  return (
    <div className=" font-serif  max-w-[312px] tablet:max-w-[667px] desktop:mt-[100px]">
      <h2 className="font-semibold uppercase text-pink-500 text-6xl tablet:text-[100px]">
      ...
      <h3 className="font-thin text-pink-100 text-6xl tablet:text-[100px] text-right -mt-5 tablet:-mt-8 tablet:text-left tablet:pl-[90px]">
